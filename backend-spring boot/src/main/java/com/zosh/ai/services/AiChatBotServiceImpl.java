...
//                Long productId = Long.parseLong(args.getString("productId"));
    ...
    public FunctionResponse getFunctionResponse(String prompt, Long productId, Long userId) throws ProductException {
        ...
        if (!firstPart.has("functionCall")) {
            // Fallback: return the plain text response instead of failing
            String textResponse = firstPart.optString("text", "No response from model.");
            return new FunctionResponse("text", textResponse); // or adapt to your actual FunctionResponse constructor
        }
